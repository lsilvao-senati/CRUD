    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Crear Nuevo Doctores</h4>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="index.php?controller=doctores&action=store">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="numero_colegiatura" name="numero_colegiatura" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="especialidad_id" name="especialidad_id" >
                        <option value="" selected disabled>-- Seleccione Especialidad Id --</option>
                        <?php /* TODO: Populate options from database for table especialidades */ ?>
                    </select>
                </div>
