...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="index.php?controller=especialidades&action=create" class="btn btn-success">
        <i class="bi bi-plus-circle"></i> Nuevo Especialidades
    </a>
</div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                <a href="index.php?controller=especialidades&action=edit&id=<?= $row['id'] ?>"
                                   class="btn btn-sm btn-outline-primary">
                                    <i class="bi bi-pencil"></i>
                                </a>
                                <form method="POST" action="index.php?controller=especialidades&action=delete"
