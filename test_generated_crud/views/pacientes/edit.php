    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0">Editar Pacientes</h4>
            </div>
            <div class="card-body">
                ...
                <form method="POST" action="index.php?controller=pacientes&action=update">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre" name="nombre"
                           value="<?= $pacientes->nombre ?>" required>
                </div>

                <div class="mb-3">
                    <label for="dni" class="form-label">Dni</label>
                    <input type="text" class="form-control" id="dni" name="dni"
                           value="<?= $pacientes->dni ?>" required>
                </div>

                <div class="mb-3">
                    <label for="fecha_nacimiento" class="form-label">Fecha Nacimiento</label>
                    <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento"
                           value="<?= $pacientes->fecha_nacimiento ?>" required>
                </div>
